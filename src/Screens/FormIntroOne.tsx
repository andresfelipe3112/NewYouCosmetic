...
import { View, StyleSheet, Animated, Easing, Pressable, TextInput, ScrollView } from "react-native";
...
export default function FormIntroOne() {
    ...
    return (
        <View
            style={{
                display: 'flex', backgroundColor: '#0f0524', width: '100%', height: '100%',
                flexDirection: 'column', alignItems: 'center',
            }}
        >
            <Text
                style={[styles.title, { marginTop: 35 }]}
            >Iniciaremos creando tu perfil</Text>
            <Text
                style={styles.title}
            >Cuéntame algo de ti</Text>
            <Text
                style={[styles.title, { fontWeight: "normal", fontSize: 25, marginTop: 70, marginBottom: 10 }]}
            >Color de tus ojos</Text>
            <View
                style={{
                    width: "70%", height: 60, display: "flex", backgroundColor: '#2b1361', justifyContent: 'center',
                    borderRadius: 10, marginBottom: 5, flexDirection: "row", alignItems: "center",
                }}
            >
                <TextInput
                    style={{
