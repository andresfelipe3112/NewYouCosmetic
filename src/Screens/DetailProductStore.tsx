  ...
  const data = [
    {
      ...
      direction:
        'Avenida, Av. las Condes 13451, Santiago de Chile, Lo Barnechea',
      description:
      ...
      image: imageA,
      position: {latitude: -33.45219, longitude: -70.682445},
    },
    {
      nombre: 'NIKE',
      instagram: 'nike',
      ...
      description:
        'La marca Nike representa el éxito empresarial. Grandes deportistas llevan sus prendas y zapatillas deportivas y millones de personas en todo el mundo compran sus productos. [...] | vía Definición ABC https://www.definicionabc.com/economia/nike.php',
      direction:
        'Av. Lo Espejo 943, Maipú, Región Metropolitana, Chile. LOCAL 160',
      city: 'Santiago de Chile',
      image: imageB,
      position: {latitude: -33.413333, longitude: -70.581575},
    },
    // {
    //   nombre: "FASHION",
    //   city: 'Santiago de Chile',
    ...
    return (
      <View
        ...
        <View
          ...
          <Text style={{fontSize: 14, alignSelf: 'center'}}>{item.city}</Text>
      ...
      <View style={{width: '100%', height: '100%'}}>
        <View
          ...
          <View
            ...
            <Text style={{fontSize: 13, alignSelf: 'center', width: '90%'}}>
              {item.owner}
            </Text>
            <Text
              style={{
            ...
            <View
              ...
              <Image
                onPress={() =>
                  Linking.openURL(
                    `https://www.instagram.com/${item.rrss.instagram
                      .split('')
                      .slice(1)
                      .join('')}`,
                  )
              ...
              <Image
                onPress={() =>
                  Linking.openURL(
                    `https://api.whatsapp.com/send?phone=${item.rrss.whatsapp}`,
                  )
                }
                style={{
                  width: 60,
              ...
              <Image
                onPress={() =>
                  Linking.openURL(`http://maps.google.com/?q="+${item.address}`)
                }
                style={{
                  width: 70,
                  height: 70,
