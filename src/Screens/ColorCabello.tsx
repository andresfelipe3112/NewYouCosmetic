...
const ColorCabello = ({route}) => {
    ...
    return (
        <>
            ...
            >
                <Text
                    style={[styles.textTitle, {marginTop:-40}]}
                >¿De que color es tu cabello?</Text>
                <View
                    style={{
                ...
                >
                    <View
                        style={{
                            ...
                            borderRadius: 10, marginBottom: 5, flexDirection: "row", alignItems: "center", marginTop: 23, 
                        }}
                    >
                        <TextInput
                            style={{
                                alignSelf: "center", alignItems: "center", color: "white", fontSize: 16,
