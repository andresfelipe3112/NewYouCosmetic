...
const Bronceado = ({route}) => {
    ...
    const genderApi = async (valueInput: string,) => {
        try {
            ...
            const resp = await newApi.post('/users/SunTanning', { "sunTanning": valueInput });
            ...
            >
                ...
                >
                    ...
                    >
                        <TextInput
                            style={{
                                alignSelf: "center", alignItems: "center", color: "white", fontSize: 15,
                    ...
                    <AnimatedPressable
                        style={[styles.inputOptions, { height: maxHeightInput }]}
                        onPress={() => {
                            setvalueInput("bronceadoTipo2");
                            active()
                        }}>
                        <Text
                            style={styles.textInput}
                        >{"Tono leve tostado"}</Text>
                    </AnimatedPressable>
                    <AnimatedPressable
                        style={[styles.inputOptions, { height: maxHeightInput }]}
                        onPress={() => {
                            setvalueInput("bronceadoTipo3");
                            active()
                        }}>
                        <Text
                            style={styles.textInput}
                    ...
                    <AnimatedPressable
                        style={[styles.inputOptions, { height: maxHeightInput }]}
                        onPress={() => {
                            setvalueInput("bronceadoTipo5");
                            active()
                        }}>
                        <Text
                            style={[styles.textInput, {textAlign: "center"}]}
                        >{"Parezco bronceada todo el año"}</Text>
                    </AnimatedPressable>
                    ...
                    />}
                     <View
                style={{
                    position: "absolute", top: Dimensions.get("window").height * 0.55, display: "flex", flexDirection: "row",
